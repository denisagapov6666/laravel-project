                    ...
                    <div class="col-md-9">
                        <div class="contact-left-content ">
                            <div class="section-title mb45 headline text-left">
                                <h3 class = "text-uppercase"><span><?php echo app('translator')->get('labels.frontend.layouts.partials.contact_us'); ?></span></h3>
                                <h4>

                                    <span class="text-weight-blod"><?php echo app('translator')->get('labels.frontend.layouts.partials.get_in_touch'); ?></span>
                                </h4>
                                <!-- <p>
                                        ...
                                        <div class="address-details ul-li-block">
                                            <ul>
                                                <?php if($contact_data["primary_address"]["status"] == 1): ?>
                                                    <li>
                                                        <span><?php echo app('translator')->get('labels.frontend.layouts.partials.primary'); ?></span>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="address-details ul-li-block">
                                            <ul>
                                                <?php if($contact_data["primary_email"]["status"] == 1): ?>
                                                    <li>
                                                        <span><?php echo app('translator')->get('labels.frontend.layouts.partials.second'); ?></span>
                                                        <br><?php echo e($contact_data["primary_email"]["value"]); ?>
...
<?php /**PATH D:\04_01_24\resources\views/frontend/layouts/partials/contact_area.blade.php ENDPATH**/ ?>