...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div id="question_edit" class="card-body row">
            <div class="col-4" style = "overflow:hidden">             
                ...
                <div class="logic_tree question_tree" style="overflow:hidden; display:none">
                ...
                <div class="logic_tree textgroup_tree" style="overflow:hidden; display:none">
                    <ul class="treecontent">
            ...
            <div class="edit col-8" >  
                <div class="row main-content" id="matrix_part">                
                    <div class="col-12" id="mat_set" style = "display:flex!important">
                        <div class = "col-6">
                            <div class="col-12">
                                <div>
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\04_01_24\resources\views/backend/charts/edit.blade.php ENDPATH**/ ?>