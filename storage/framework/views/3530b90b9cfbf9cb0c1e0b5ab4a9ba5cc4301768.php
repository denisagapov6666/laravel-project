...
<link href="<?php echo e(asset('css/custom.css')); ?>?t=<?php echo e(time()); ?>"  rel="stylesheet" type="text/css"/>
                                ...
                                <?php if(count($lesson->questions) > 0  ): ?>
                                    <form action="<?php echo e(route('lessons.test', [$lesson->slug])); ?>" method="post">
                                        ...
                                        <div id="question_form" >
                                            <?php echo $__env->make('backend.orders.components.questions.questions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    </form>
                                <?php endif; ?>
                            </div>
...
//        data.append('')
    ...
    $(document).on('click', '#create-report', function (e) {
        ...
        if (flag != false) {
            ...
            getReportRoute = '<?php echo e($route); ?>';
    ...
    $(document).on('click', '#update-report', function (e) {
        ...
        var updateReportRoute = '';
            ...
            updateReportRoute = '<?php echo e($route); ?>';
        $.ajax({
            data: {
                test_id : test_id,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\04_01_24\resources\views/backend/orders/questions.blade.php ENDPATH**/ ?>