        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    ...
                    <?php echo Form::color('color1', old('color1','#0000ff'), ['class' => 'form-control ']); ?>

                </div>
                <div class="col-12 col-lg-6 form-group">
                    <?php echo Form::label('color2',trans('labels.backend.tests.fields.color2'), ['class' => 'control-label']); ?>

                    <?php echo Form::color('color2', old('color2',"#808080"), ['class' => 'form-control ']); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\04_01_24\resources\views/backend/tests/create.blade.php ENDPATH**/ ?>