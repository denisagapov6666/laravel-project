...
<div class="mt-2">
    <form id="question_type_image" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="hidden" id="font_style" name="num_files" value="<?php echo e($fontstyle2); ?>">
...
<script>
    ...
    $("body").append(`<style>#q_<?php echo $question->id ?> #files::file-selector-button{<?php echo $fontstyle2 ?>background:<?php echo e($question->color1 == NULL ? $lesson->color1 : $question->color1); ?>;}</style>`)  
</script><?php /**PATH D:\04_01_24\resources\views/backend/orders/components/questions/file.blade.php ENDPATH**/ ?>